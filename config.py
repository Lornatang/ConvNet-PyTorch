...
if mode == "train":
    ...
    pretrained_model_weights_path = "./results/pretrained_models/ConvNext_tiny-ImageNet_1K-b03a77c2.pth.tar"
...
if mode == "test":
    ...
    model_weights_path = "./results/pretrained_models/ConvNext_tiny-ImageNet_1K-b03a77c2.pth.tar"
